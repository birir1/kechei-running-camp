<section class="athletes-stories-section py-5">
    <div class="container">
        <!-- Section Title -->
        <h2 class="athletes-stories-heading text-center mb-5">Athletes Stories</h2>
        
        <!-- Athletes Stories Grid -->
        <div class="row">
            <!-- Story 1 -->
            <div class="col-md-4 mb-4">
                <div class="athlete-story-card">
                    <img src="{{ asset('img/images/olympic.jpeg') }}" alt="Athlete 1" class="story-img img-fluid">
            ...
            <div class="col-md-4 mb-4">
                <div class="athlete-story-card">
                    <img src="{{ asset('img/images/run2.jpeg') }}" alt="Athlete 3" class="story-img img-fluid">
                    <div class="story-content">
