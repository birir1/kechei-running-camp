<div class="activities-section" style="background-color: #f9f9f9; padding: 60px 20px; text-align: center; font-family: 'Times New Roman', serif; box-shadow: 0px 4px 20px rgba(0, 0, 0, 0.1); border-radius: 15px;">
    <div class="activities-header" style="max-width: 900px; margin: 0 auto; margin-bottom: 40px;">
        <h2 style="font-size: 36px; color: #143009; margin-bottom: 10px;">Other Fun Activities</h2>
        <p style="font-size: 18px; color: #555; line-height: 1.8;">
            Enhance your experience with a variety of exciting activities. Whether you're looking to relax, get fit, or enjoy local culture, there's something for everyone!
        </p>
    </div>
    ...
    <!-- Exclusive Services -->
    <div class="exclusive-section" style="margin-top: 60px; padding: 30px; background-color: #eeb601; border-radius: 15px;">
        <h3 style="font-size: 28px; color: #143009; margin-bottom: 10px;">Exclusive Services</h3>
        <p style="font-size: 18px; color: #fff;">Take advantage of our exclusive offerings to make your stay even more special:</p>
        <ul style="list-style-type: none; padding: 0; margin: 20px auto; max-width: 600px; font-size: 18px; color: #fff; font-weight: bold; line-height: 1.8;">
            <li>🦒 Safari Adventure</li>
            <li>💆 Additional Massage Services</li>
        </ul>
    </div>
</div>
