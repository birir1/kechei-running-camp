<section class="events-gallery-section py-5">
    <div class="container">
        <!-- Section Title -->
        <h2 class="events-gallery-heading text-center mb-5">Events Gallery</h2>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="event-card">
                    ...
                    <div class="event-info">
                        ...
                        <p class="event-date">April 8, 2024</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="event-card">
                    ...
                    <div class="event-info">
                        ...
                        <p class="event-date">July 22, 2024</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="event-card">
                    <div class="event-image-wrapper">
                        <img src="{{ asset('img/train8.png') }}" alt="Event 6" class="event-img img-fluid">
                    </div>
                    <div class="event-info">
                        <h4 class="event-title">Cross-Country Challenge</h4>
                        <p class="event-date">August 12, 2024</p>
                    </div>
                </div>
            </div>
        </div>
